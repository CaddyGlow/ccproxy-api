...
class SystemMessage(AnthropicBaseModel):
...
class ThinkingConfig(AnthropicBaseModel):
...
class MetadataParams(AnthropicBaseModel):
...
class ToolChoiceParams(AnthropicBaseModel):
...
class MessageCreateParams(AnthropicBaseModel):
...
class TextContentBlock(AnthropicBaseModel):
    """Text content block."""
...
class ToolUseContentBlock(AnthropicBaseModel):
...
class ThinkingContentBlock(AnthropicBaseModel):
...
class MessageResponse(AnthropicBaseModel):
