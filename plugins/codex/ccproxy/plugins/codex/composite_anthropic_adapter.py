...
class CompositeAnthropicAdapter(APIAdapter):
    ...
    async def adapt_request(self, request_data: dict[str, Any]) -> dict[str, Any]:
        ...
        try:
            ...
            logger.error(
                ...
                error=str(e),
                request_keys=list(request_data.keys()) if isinstance(request_data, dict) else "not_dict",
                exc_info=e,
            )
            raise
    ...
    async def adapt_response(self, response_data: dict[str, Any]) -> dict[str, Any]:
        ...
        try:
            ...
            openai_response = self.response_adapter.response_to_chat_completion(response_data)
            ...
            anthropic_response = self._openai_to_anthropic_response(openai_response_dict)
    ...
    def _anthropic_to_openai_request(self, anthropic_request: dict[str, Any]) -> dict[str, Any]:
        ...
        openai_request = {
            ...
            "messages": self._anthropic_messages_to_openai(anthropic_request.get("messages", [])),
        }
        ...
        if "tools" in anthropic_request:
            openai_request["tools"] = self._anthropic_tools_to_openai(anthropic_request["tools"])
    ...
    def _anthropic_messages_to_openai(self, anthropic_messages: list[dict[str, Any]]) -> list[dict[str, Any]]:
    ...
    def _anthropic_tools_to_openai(self, anthropic_tools: list[dict[str, Any]]) -> list[dict[str, Any]]:
    ...
    def _anthropic_tool_choice_to_openai(self, anthropic_tool_choice: str | dict[str, Any]) -> str | dict[str, Any]:
    ...
    def _openai_to_anthropic_response(self, openai_response: dict[str, Any]) -> dict[str, Any]:
